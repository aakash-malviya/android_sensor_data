...
public final class Fragment3Binding implements ViewBinding {
  ...
  private Fragment3Binding(@NonNull FrameLayout rootView, @NonNull Button c3, @NonNull Button h3,
      @NonNull Button t3) {
  ...
  public static Fragment3Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.h3;
      Button h3 = ViewBindings.findChildViewById(rootView, id);
      if (h3 == null) {
        break missingId;
      }
      ...
      return new Fragment3Binding((FrameLayout) rootView, c3, h3, t3);
    }
